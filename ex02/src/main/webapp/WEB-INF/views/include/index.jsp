...
<div class="card-deck">
  <div class="card">
    <img class="1row card-img-top" src="../img/20180127_636526505002368405.jpg" alt="Card image cap">
    <div class="card-body">
  ...
  <div class="card">
    <img class="1row card-img-top" src="../img/20180617_636647835006241263.jpg" alt="Card image cap">
    <div class="card-body">
      <h4 class="card-title">Card title</h4>
  ...
  <div class="card">
    <img class="1row card-img-top" src="../img/20180821_636704470273647213.jpg" alt="Card image cap">
    <div class="card-body">
      <h4 class="card-title">Card title</h4>
  ...
  <div class="card-deck">
  <div class="card">
    <img class="2row card-img-top" src="../img/20180822_636704772251974730.jpg" alt="Card image cap">
    <div class="card-body">
      <h4 class="card-title">Card title</h4>
      <p class="card-text">This is a longer card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
      <p class="card-text"><small class="text-muted">Last updated 3 mins ago</small></p>
  ...
  <div class="card">
    <img class="2row card-img-top" src="../img/20180822_636704807432415100.jpg" alt="Card image cap">
    <div class="card-body">
      <h4 class="card-title">Card title</h4>
      <p class="card-text">This card has supporting text below as a natural lead-in to additional content.</p>
      <p class="card-text"><small class="text-muted">Last updated 3 mins ago</small></p>
  ...
  <div class="card">
    <img class="2row card-img-top" src="../img/20180822_636704897701590088.jpg" alt="Card image cap">
    <div class="card-body">
      <h4 class="card-title">Card title</h4>
      <p class="card-text">This is a wider card with supporting text below as a natural lead-in to additional content. This card has even longer content than the first to show that equal height action.</p>
      <p class="card-text"><small class="text-muted">Last updated 3 mins ago</small></p>
  ...
  <div class="card-deck">
  <div class="card">
    <img class="3row card-img-top" src="../img/20180822_636704807432415100.jpg" alt="Card image cap">
    <div class="card-body">
      <h4 class="card-title">Card title</h4>
      <p class="card-text">This is a longer card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
      <p class="card-text"><small class="text-muted">Last updated 3 mins ago</small></p>
  ...
  <div class="card">
    <img class="3row card-img-top" src="../img/20180822_636704844261602930.jpg" alt="Card image cap">
    <div class="card-body">
      <h4 class="card-title">Card title</h4>
      <p class="card-text">This card has supporting text below as a natural lead-in to additional content.</p>
      <p class="card-text"><small class="text-muted">Last updated 3 mins ago</small></p>
  ...
  <div class="card">
    <img class="3row card-img-top" src="../img/20180822_636704897654503796.jpg" alt="Card image cap">
    <div class="card-body">
      <h4 class="card-title">Card title</h4>
      <p class="card-text">This is a wider card with supporting text below as a natural lead-in to additional content. This card has even longer content than the first to show that equal height action.</p>
      <p class="card-text"><small class="text-muted">Last updated 3 mins ago</small></p>
