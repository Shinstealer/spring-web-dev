			...
			<section id="content">
				...
				<div id="main">
				  <article id="mArticle">
					...
					<form action="/user/loginPost" name="loginfmt" method="POST">
					  <div class="cont_login">
					  	<!-- ID -->
						<div class="login_inp" id="login_Email">
							<input type="text" id="loginEmail" name="uid" class="inp_login inp_email" placeholder="이메일을 또는 전화번호">
						</div>	
						
						<!--password  -->
						<div class="login_inp" id="login_PW">
							<input type="password" id="loginPw" name="upw"  class="inp_login inp_pw" placeholder="비밀번호(8~32자리)">
						</div>
						<div class="set_login">
							<label class="lab_check" for="keepLoging">	
							<input type="checkbox" id="keepLoging" name="useCookie" value="true" class="inp_check">
								로그인 상태 유지
